...
public class ModTags {
    public static final class Blocks {
        ...
        // Default namespace is mod ID, so this one will be "lootbagmod:example_block"
        public static final Tag<Block> EXAMPLE2 = tag("example_block");

        private Blocks() {}

        private static Tag<Block> tag(String name) {
            return new BlockTags.Wrapper(new ResourceLocation(TreasureBags.MOD_ID, name));
        }
    ...
    public static final class Items {
        // Item tags work the same way as block tags, so this is "lootbagmod:example_item"
        public static final Tag<Item> EXAMPLE = tag("example_item");

        private Items() {}

        private static Tag<Item> tag(String name) {
            return new ItemTags.Wrapper(new ResourceLocation(TreasureBags.MOD_ID, name));
        }
